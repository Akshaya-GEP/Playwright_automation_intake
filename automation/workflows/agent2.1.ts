...
/**
 * Agent 2.1 workflow - Parameterized for BDD.
 */
export async function workflowAgent2_1(page: Page, ctx: AgentContext, data: ContractAmendmentRow) {
  console.log(`Starting Agent 2.1 Workflow for Sno: ${data.sno}`);
